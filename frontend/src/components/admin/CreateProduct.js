...
const CreateProduct = () => {
    ...
    const productForm = () => (
        <form className="mb-3" onSubmit={handleSubmit}>
            <h4 style= {{color: '#004018'}}>Photo:</h4>
            ...
            <button className="btn btn-outline-success" type="submit" disabled={disabled}>Create Med Device</button>
        </form>
    );

    const goBack = () => (<div className="mt-5">
        <Link to="/admin/dashboard" style={{color: '#000000', textDecoration: 'none'}}>Go to Dashboard</Link>
    </div>)
